...
public class Converter {
    ...
    // Inputs numbers
    protected static double inputString(javafx.scene.control.TextField field) {
        num = Long.decode(field.getText().trim());
        return num;
    }

    // Converts minutes to hours
    protected static String toHours() {
    ...
    protected static String toDays() {
    ...
    protected static String toMonths() {
    ...
    protected static String toYears() {
